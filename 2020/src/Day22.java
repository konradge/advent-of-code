...
public class Day22 implements Day {
    ...
    public static class Game {
        ...
        public static boolean playGame(Queue<Integer> c1, int quantity1, Queue<Integer> c2, int quantity2) {
            Game g = new Day22.Game(new LinkedList<>(c1.stream().collect(Collectors.toList()).subList(0, quantity1)),
                    new LinkedList<>(c2.stream()
                            .collect(Collectors.toList()).subList(0, quantity2)));
            return g.play();
        }
        ...
        public boolean play() {
            ...
            while (!cards1.isEmpty() && !cards2.isEmpty()) {
                ...
                if (alreadySeenCards.getOrDefault(cards1.hashCode() + "|" + cards2.hashCode(), false)) {
                    ...
                    // if (alreadySeenCards.size() > 50 * 50)
                    // System.out.println(alreadySeenCards.size());
